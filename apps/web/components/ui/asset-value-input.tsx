  ...
  return (
    <div className={cn(className, "flex flex-col")}>
      ...
      <Input
        ...
        className="mt-2 text-xl font-bold text-blue-600 dark:text-blue-400 border-2 border-blue-200 dark:border-blue-800 focus:border-blue-500 dark:focus:border-blue-400"
      />
    </div>
  );
}
