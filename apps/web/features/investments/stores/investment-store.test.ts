...
describe('Investment Store', () => {
  ...
  describe('History Record Management', () => {
    ...
    it('should remove history record by date (except latest)', () => {
      ...
      expect(state.investments[0]!.records.map(r => r.date)).toEqual(['2024-01-15', '2024-01-05']);
    });
  });
  ...
  describe('Store Reset', () => {
    it('should reset store to initial state', () => {
      const { addInvestment, addCustomOwner, setExpandedFormId, resetStore } = useInvestmentStore.getState();
